...
//								color_rgba8888.A = 0xFF;
							...
							*gfx3d_buffer = BGRA8888_32_To_RGBA6665_32(color_rgba8888.Color);
							#else
							*gfx3d_buffer = BGRA8888_32Rev_To_RGBA6665_32Rev(color_rgba8888.Color);	// ピクセルフォーマットをRGBA6665に変換して値を保存
							#endif
							break;
				...
				if(color_rgba8888.A > 0)		// (remainder_x == 1, remainder_y == 1)：簡易中心点判定（x2:2画素の右側, x3:3画素の中央, x4:4画素の左から2つめを中心点と見なす）
					*gfx3d_buffer = color_rgba8888.Color;
